	...
	var DateTimeField = (function (_Component) {
	  ...
	  function DateTimeField() {
	    ...
	    this.componentWillReceiveProps = function (nextProps) {
	      ...
	      if (nextProps.inputFormat !== _this.props.inputFormat) {
	        ...
	        state.inputValue = _this.props.moment(nextProps.dateTime, nextProps.format, true).format(nextProps.inputFormat);
	      }

	      if (nextProps.dateTime !== _this.props.dateTime && _this.props.moment(nextProps.dateTime, nextProps.format, true).isValid()) {
	        state.viewDate = _this.props.moment(nextProps.dateTime, nextProps.format, true).startOf("month");
	        state.selectedDate = _this.props.moment(nextProps.dateTime, nextProps.format, true);
	        state.inputValue = _this.props.moment(nextProps.dateTime, nextProps.format, true).format(nextProps.inputFormat ? nextProps.inputFormat : _this.state.inputFormat);
	      }
	    ...
	    this.onChange = function (event) {
	      ...
	      if (_this.props.moment(value, _this.state.inputFormat, true).isValid()) {
	        _this.setState({
	          selectedDate: _this.props.moment(value, _this.state.inputFormat, true),
	          viewDate: _this.props.moment(value, _this.state.inputFormat, true).startOf("month")
	        });
	      }
	    ...
	    this.getValue = function () {
	      return _this.props.moment(_this.state.inputValue, _this.props.inputFormat, true).format(_this.props.format);
	    };
	  ...
	  _createClass(DateTimeField, [{
	    ...
	    value: {
	      ...
	      moment: _react.PropTypes.object
	    },
	    enumerable: true
	  }]);
	...
	var DateTimePickerDays = (function (_Component) {
	  ...
	  function DateTimePickerDays() {
	    ...
	    this.renderDays = function () {
	      ...
	      nextMonth = _this.props.moment(prevMonth).clone().add(42, "d");
	      ...
	      while (prevMonth.isBefore(nextMonth)) {
	        ...
	        if (prevMonth.isSame(_this.props.moment({
	        ...
	        if (_this.props.showToday) {
	          if (prevMonth.isSame(_this.props.moment(), "day")) {
	            classes.today = true;
	          }
	        }
	        ...
	        if (prevMonth.weekday() === _this.props.moment().endOf("week").weekday()) {
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              ...
	              _react2["default"].createElement(
	                ...
	                this.props.moment.months()[this.props.viewDate.month()],
	                " ",
	...
	var DateTimePickerMonths = (function (_Component) {
	  ...
	  function DateTimePickerMonths() {
	    ...
	    this.renderMonths = function () {
	      ...
	      monthsShort = _this.props.moment.monthsShort();
	      i = 0;
	      months = [];
	      while (i < 12) {
	        classes = {
